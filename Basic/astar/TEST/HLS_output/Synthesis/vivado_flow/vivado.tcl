proc dump_statistics {  } {
  ...
  file delete -force HLS_output//Synthesis/vivado_flow/heuristic_report.xml 
  set ofile_report [open HLS_output//Synthesis/vivado_flow/heuristic_report.xml w]
...
create_project heuristic -part xc7z020clg484-1 -force
read_verilog heuristic.v
read_xdc HLS_output//Synthesis/vivado_flow/heuristic.sdc
synth_design -top heuristic -part xc7z020clg484-1
