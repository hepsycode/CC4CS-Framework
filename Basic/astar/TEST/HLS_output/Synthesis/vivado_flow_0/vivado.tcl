proc dump_statistics {  } {
  ...
  file delete -force HLS_output//Synthesis/vivado_flow_0/absolute_report.xml 
  set ofile_report [open HLS_output//Synthesis/vivado_flow_0/absolute_report.xml w]
...
create_project absolute -part xc7z020clg484-1 -force
read_verilog absolute.v
read_xdc HLS_output//Synthesis/vivado_flow_0/absolute.sdc
synth_design -top absolute -part xc7z020clg484-1
