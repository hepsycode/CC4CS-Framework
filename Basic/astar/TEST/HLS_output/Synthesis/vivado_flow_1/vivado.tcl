proc dump_statistics {  } {
  ...
  file delete -force HLS_output//Synthesis/vivado_flow_1/set_estimates_report.xml 
  set ofile_report [open HLS_output//Synthesis/vivado_flow_1/set_estimates_report.xml w]
...
create_project set_estimates -part xc7z020clg484-1 -force
read_verilog set_estimates.v
read_xdc HLS_output//Synthesis/vivado_flow_1/set_estimates.sdc
synth_design -top set_estimates -part xc7z020clg484-1
