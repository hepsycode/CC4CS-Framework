proc dump_statistics {  } {
  ...
  file delete -force HLS_output//Synthesis/vivado_flow_2/remove_min_report.xml 
  set ofile_report [open HLS_output//Synthesis/vivado_flow_2/remove_min_report.xml w]
...
set outputDir HLS_output//Synthesis/vivado_flow_2
file mkdir $outputDir
create_project remove_min -part xc7z020clg484-1 -force
read_verilog remove_min.v
read_xdc HLS_output//Synthesis/vivado_flow_2/remove_min.sdc
synth_design -top remove_min -part xc7z020clg484-1
