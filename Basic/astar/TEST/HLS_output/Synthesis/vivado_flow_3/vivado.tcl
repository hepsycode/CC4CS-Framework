proc dump_statistics {  } {
  ...
  file delete -force HLS_output//Synthesis/vivado_flow_3/insert_report.xml 
  set ofile_report [open HLS_output//Synthesis/vivado_flow_3/insert_report.xml w]
...
set outputDir HLS_output//Synthesis/vivado_flow_3
file mkdir $outputDir
create_project insert -part xc7z020clg484-1 -force
read_verilog insert.v
read_xdc HLS_output//Synthesis/vivado_flow_3/insert.sdc
synth_design -top insert -part xc7z020clg484-1
