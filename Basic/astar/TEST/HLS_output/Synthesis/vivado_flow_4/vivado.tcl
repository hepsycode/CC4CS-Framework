proc dump_statistics {  } {
  ...
  file delete -force HLS_output//Synthesis/vivado_flow_4/init_camefrom_report.xml 
  set ofile_report [open HLS_output//Synthesis/vivado_flow_4/init_camefrom_report.xml w]
...
set outputDir HLS_output//Synthesis/vivado_flow_4
file mkdir $outputDir
create_project init_camefrom -part xc7z020clg484-1 -force
read_verilog init_camefrom.v
read_xdc HLS_output//Synthesis/vivado_flow_4/init_camefrom.sdc
synth_design -top init_camefrom -part xc7z020clg484-1
