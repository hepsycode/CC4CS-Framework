proc dump_statistics {  } {
  ...
  file delete -force HLS_output//Synthesis/vivado_flow_5/make_oriented_report.xml 
  set ofile_report [open HLS_output//Synthesis/vivado_flow_5/make_oriented_report.xml w]
...
set outputDir HLS_output//Synthesis/vivado_flow_5
file mkdir $outputDir
create_project make_oriented -part xc7z020clg484-1 -force
read_verilog make_oriented.v
read_xdc HLS_output//Synthesis/vivado_flow_5/make_oriented.sdc
synth_design -top make_oriented -part xc7z020clg484-1
