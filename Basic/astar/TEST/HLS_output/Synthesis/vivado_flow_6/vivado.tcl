proc dump_statistics {  } {
  ...
  file delete -force HLS_output//Synthesis/vivado_flow_6/astar_report.xml 
  set ofile_report [open HLS_output//Synthesis/vivado_flow_6/astar_report.xml w]
...
set outputDir HLS_output//Synthesis/vivado_flow_6
file mkdir $outputDir
create_project astar -part xc7z020clg484-1 -force
read_verilog astar.v
read_xdc HLS_output//Synthesis/vivado_flow_6/astar.sdc
synth_design -top astar -part xc7z020clg484-1
