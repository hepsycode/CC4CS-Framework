proc dump_statistics {  } {
  ...
  file delete -force HLS_output//Synthesis/vivado_flow_8/astar_report.xml 
  set ofile_report [open HLS_output//Synthesis/vivado_flow_8/astar_report.xml w]
...
set outputDir HLS_output//Synthesis/vivado_flow_8
file mkdir $outputDir
create_project astar -part xc7z020clg484-1 -force
read_verilog astar.v
read_xdc HLS_output//Synthesis/vivado_flow_8/astar.sdc
