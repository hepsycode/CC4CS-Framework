...
// Code created using PandA - Version: PandA 0.9.6 - Revision 891ec3caed502474cab0813cc4a9fc678deabaa5 - Date 2021-02-11T17:58:06
// bambu executed with: bambu -I. --top-fname=init_camefrom frst.c 
// 
...
`timescale 1ns / 1ps
module datapath_init_camefrom(clock, reset, S_oe_ram, S_we_ram, S_addr_ram, S_Wdata_ram, S_data_ram_size, Sin_Rdata_ram, Sin_DataRdy, Sout_Rdata_ram, Sout_DataRdy, fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_LOAD, fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_STORE, fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i0_LOAD, fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i0_STORE, fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i1_LOAD, fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i1_STORE);
  parameter MEM_var_28861_28871=32, MEM_var_28865_28871=64;
  // IN
  input clock;
  input reset;
  input [1:0] S_oe_ram;
  ...
  wire [6:0] out_UUdata_converter_FU_5_i0_fu_init_camefrom_28871_29550;
  wire [6:0] out_addr_expr_FU_4_i0_fu_init_camefrom_28871_29584;
  wire [5:0] out_addr_expr_FU_6_i0_fu_init_camefrom_28871_29578;
  ...
  wire [6:0] out_conv_out_addr_expr_FU_6_i0_fu_init_camefrom_28871_29578_6_7;
  wire [3:0] out_conv_out_const_1_5_4;
  wire [31:0] out_conv_out_const_4_6_32;
  wire [31:0] out_conv_out_const_5_7_32;
  wire [6:0] out_ui_pointer_plus_expr_FU_8_0_8_8_i0_fu_init_camefrom_28871_29574;
  ...
  constant_value #(.BITSIZE_out1(8), .value(8'b00000010)) const_0 (.out1(out_const_0));
  ...
  constant_value #(.BITSIZE_out1(6), .value(MEM_var_28861_28871)) const_4 (.out1(out_const_4));
  constant_value #(.BITSIZE_out1(7), .value(MEM_var_28865_28871)) const_5 (.out1(out_const_5));
  UUdata_converter_FU #(.BITSIZE_in1(6), .BITSIZE_out1(7)) conv_out_addr_expr_FU_6_i0_fu_init_camefrom_28871_29578_6_7 (.out1(out_conv_out_addr_expr_FU_6_i0_fu_init_camefrom_28871_29578_6_7), .in1(out_addr_expr_FU_6_i0_fu_init_camefrom_28871_29578));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(7), .BITSIZE_out1(7)) fu_init_camefrom_28871_29550 (.out1(out_UUdata_converter_FU_5_i0_fu_init_camefrom_28871_29550), .in1(out_addr_expr_FU_4_i0_fu_init_camefrom_28871_29584));
  ui_pointer_plus_expr_FU #(.BITSIZE_in1(7), .BITSIZE_in2(1), .BITSIZE_out1(7), .LSB_PARAMETER(0)) fu_init_camefrom_28871_29574 (.out1(out_ui_pointer_plus_expr_FU_8_0_8_8_i0_fu_init_camefrom_28871_29574), .in1(out_UUdata_converter_FU_5_i0_fu_init_camefrom_28871_29550), .in2(out_const_2));
  addr_expr_FU #(.BITSIZE_in1(32), .BITSIZE_out1(6)) fu_init_camefrom_28871_29578 (.out1(out_addr_expr_FU_6_i0_fu_init_camefrom_28871_29578), .in1(out_conv_out_const_4_6_32));
  addr_expr_FU #(.BITSIZE_in1(32), .BITSIZE_out1(7)) fu_init_camefrom_28871_29584 (.out1(out_addr_expr_FU_4_i0_fu_init_camefrom_28871_29584), .in1(out_conv_out_const_5_7_32));
...
// License: THIS COMPONENT IS PROVIDED "AS IS" AND WITHOUT ANY EXPRESS OR IMPLIED WARRANTIES, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTIBILITY AND FITNESS FOR A PARTICULAR PURPOSE.
`timescale 1ns / 1ps
module _init_camefrom(clock, reset, start_port, done_port, S_oe_ram, S_we_ram, S_addr_ram, S_Wdata_ram, S_data_ram_size, Sin_Rdata_ram, Sin_DataRdy, Sout_Rdata_ram, Sout_DataRdy);
  parameter MEM_var_28861_28871=32, MEM_var_28865_28871=64;
  // IN
  input clock;
  input reset;
...
// Minimal interface for function: init_camefrom
// This component has been derived from the input source code and so it does not fall under the copyright of PandA framework, but it follows the input source code copyright, and may be aggregated with components of the BAMBU/PANDA IP LIBRARY.
// Author(s): Component automatically generated by bambu
// License: THIS COMPONENT IS PROVIDED "AS IS" AND WITHOUT ANY EXPRESS OR IMPLIED WARRANTIES, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTIBILITY AND FITNESS FOR A PARTICULAR PURPOSE.
`timescale 1ns / 1ps
module init_camefrom(clock, reset, start_port, S_oe_ram, S_we_ram, S_addr_ram, S_Wdata_ram, S_data_ram_size, done_port, Sout_Rdata_ram, Sout_DataRdy);
  parameter MEM_var_28861_28871=32, MEM_var_28865_28871=64;
  // IN
  input clock;
  input reset;
  ...
  _init_camefrom #(.MEM_var_28861_28871(MEM_var_28861_28871), .MEM_var_28865_28871(MEM_var_28865_28871)) _init_camefrom_i0 (.done_port(done_port), .Sout_Rdata_ram(Sout_Rdata_ram), .Sout_DataRdy(Sout_DataRdy), .clock(clock), .reset(reset), .start_port(start_port), .S_oe_ram(S_oe_ram), .S_we_ram(S_we_ram), .S_addr_ram(S_addr_ram), .S_Wdata_ram(S_Wdata_ram), .S_data_ram_size(S_data_ram_size), .Sin_Rdata_ram({8'b00000000, 8'b00000000}), .Sin_DataRdy({1'b0, 1'b0}));
