...
// Code created using PandA - Version: PandA 0.9.6 - Revision 891ec3caed502474cab0813cc4a9fc678deabaa5 - Date 2021-02-11T17:57:42
// bambu executed with: bambu -I. --top-fname=set_estimates frst.c 
// 
...
`timescale 1ns / 1ps
module datapath_set_estimates(clock, reset, S_oe_ram, S_we_ram, S_addr_ram, S_Wdata_ram, S_data_ram_size, Sin_Rdata_ram, Sin_DataRdy, Sout_Rdata_ram, Sout_DataRdy, fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_LOAD, fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_STORE, fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i0_LOAD, fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i0_STORE, fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i1_LOAD, fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i1_STORE);
  parameter MEM_var_28861_28874=32, MEM_var_28868_28874=64;
  // IN
  input clock;
  input reset;
  input [1:0] S_oe_ram;
  ...
  wire [7:0] out_UUdata_converter_FU_5_i0_fu_set_estimates_28874_29587;
  wire [6:0] out_UUdata_converter_FU_6_i0_fu_set_estimates_28874_29550;
  wire [7:0] out_UUdata_converter_FU_7_i0_fu_set_estimates_28874_29565;
  wire [7:0] out_addr_expr_FU_4_i0_fu_set_estimates_28874_29625;
  wire [5:0] out_addr_expr_FU_8_i0_fu_set_estimates_28874_29580;
  ...
  wire [6:0] out_conv_out_addr_expr_FU_8_i0_fu_set_estimates_28874_29580_6_7;
  ...
  wire [6:0] out_ui_pointer_plus_expr_FU_8_0_8_10_i0_fu_set_estimates_28874_29574;
  wire [7:0] out_ui_pointer_plus_expr_FU_8_0_8_11_i0_fu_set_estimates_28874_29615;
  ...
  constant_value #(.BITSIZE_out1(8), .value(8'b00000000)) const_0 (.out1(out_const_0));
  ...
  constant_value #(.BITSIZE_out1(8), .value(8'b01111111)) const_3 (.out1(out_const_3));
  ...
  constant_value #(.BITSIZE_out1(6), .value(MEM_var_28861_28874)) const_6 (.out1(out_const_6));
  constant_value #(.BITSIZE_out1(7), .value(MEM_var_28868_28874)) const_7 (.out1(out_const_7));
  UUdata_converter_FU #(.BITSIZE_in1(6), .BITSIZE_out1(7)) conv_out_addr_expr_FU_8_i0_fu_set_estimates_28874_29580_6_7 (.out1(out_conv_out_addr_expr_FU_8_i0_fu_set_estimates_28874_29580_6_7), .in1(out_addr_expr_FU_8_i0_fu_set_estimates_28874_29580));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(8), .BITSIZE_out1(7)) fu_set_estimates_28874_29550 (.out1(out_UUdata_converter_FU_6_i0_fu_set_estimates_28874_29550), .in1(out_UUdata_converter_FU_5_i0_fu_set_estimates_28874_29587));
  UUdata_converter_FU #(.BITSIZE_in1(8), .BITSIZE_out1(8)) fu_set_estimates_28874_29565 (.out1(out_UUdata_converter_FU_7_i0_fu_set_estimates_28874_29565), .in1(out_ui_pointer_plus_expr_FU_8_0_8_11_i0_fu_set_estimates_28874_29615));
  ui_pointer_plus_expr_FU #(.BITSIZE_in1(8), .BITSIZE_in2(1), .BITSIZE_out1(7), .LSB_PARAMETER(0)) fu_set_estimates_28874_29574 (.out1(out_ui_pointer_plus_expr_FU_8_0_8_10_i0_fu_set_estimates_28874_29574), .in1(out_UUdata_converter_FU_7_i0_fu_set_estimates_28874_29565), .in2(out_const_4));
  addr_expr_FU #(.BITSIZE_in1(32), .BITSIZE_out1(6)) fu_set_estimates_28874_29580 (.out1(out_addr_expr_FU_8_i0_fu_set_estimates_28874_29580), .in1(out_conv_out_const_6_6_32));
  UUdata_converter_FU #(.BITSIZE_in1(8), .BITSIZE_out1(8)) fu_set_estimates_28874_29587 (.out1(out_UUdata_converter_FU_5_i0_fu_set_estimates_28874_29587), .in1(out_addr_expr_FU_4_i0_fu_set_estimates_28874_29625));
  ui_pointer_plus_expr_FU #(.BITSIZE_in1(8), .BITSIZE_in2(2), .BITSIZE_out1(8), .LSB_PARAMETER(0)) fu_set_estimates_28874_29615 (.out1(out_ui_pointer_plus_expr_FU_8_0_8_11_i0_fu_set_estimates_28874_29615), .in1(out_UUdata_converter_FU_5_i0_fu_set_estimates_28874_29587), .in2(out_const_5));
  addr_expr_FU #(.BITSIZE_in1(32), .BITSIZE_out1(8)) fu_set_estimates_28874_29625 (.out1(out_addr_expr_FU_4_i0_fu_set_estimates_28874_29625), .in1(out_conv_out_const_7_7_32));
...
// License: THIS COMPONENT IS PROVIDED "AS IS" AND WITHOUT ANY EXPRESS OR IMPLIED WARRANTIES, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTIBILITY AND FITNESS FOR A PARTICULAR PURPOSE.
`timescale 1ns / 1ps
module controller_set_estimates(done_port, fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_LOAD, fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_STORE, fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i0_LOAD, fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i0_STORE, fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i1_LOAD, fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i1_STORE, clock, reset, start_port);
  // IN
  input clock;
  input reset;
  input start_port;
...
// License: THIS COMPONENT IS PROVIDED "AS IS" AND WITHOUT ANY EXPRESS OR IMPLIED WARRANTIES, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTIBILITY AND FITNESS FOR A PARTICULAR PURPOSE.
`timescale 1ns / 1ps
module _set_estimates(clock, reset, start_port, done_port, S_oe_ram, S_we_ram, S_addr_ram, S_Wdata_ram, S_data_ram_size, Sin_Rdata_ram, Sin_DataRdy, Sout_Rdata_ram, Sout_DataRdy);
  parameter MEM_var_28861_28874=32, MEM_var_28868_28874=64;
  // IN
  input clock;
  input reset;
  ...
  controller_set_estimates Controller_i (.done_port(done_delayed_REG_signal_in), .fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_LOAD(fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_LOAD), .fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_STORE(fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_STORE), .fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i0_LOAD(fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i0_LOAD), .fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i0_STORE(fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i0_STORE), .fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i1_LOAD(fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i1_LOAD), .fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i1_STORE(fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i1_STORE), .clock(clock), .reset(reset), .start_port(start_port));
  datapath_set_estimates #(.MEM_var_28861_28874(MEM_var_28861_28874), .MEM_var_28868_28874(MEM_var_28868_28874)) Datapath_i (.Sout_Rdata_ram(Sout_Rdata_ram), .Sout_DataRdy(Sout_DataRdy), .clock(clock), .reset(reset), .S_oe_ram(S_oe_ram), .S_we_ram(S_we_ram), .S_addr_ram(S_addr_ram), .S_Wdata_ram(S_Wdata_ram), .S_data_ram_size(S_data_ram_size), .Sin_Rdata_ram(Sin_Rdata_ram), .Sin_DataRdy(Sin_DataRdy), .fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_LOAD(fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_LOAD), .fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_STORE(fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_STORE), .fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i0_LOAD(fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i0_LOAD), .fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i0_STORE(fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i0_STORE), .fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i1_LOAD(fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i1_LOAD), .fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i1_STORE(fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_1_i1_STORE));
...
// Minimal interface for function: set_estimates
// This component has been derived from the input source code and so it does not fall under the copyright of PandA framework, but it follows the input source code copyright, and may be aggregated with components of the BAMBU/PANDA IP LIBRARY.
// Author(s): Component automatically generated by bambu
// License: THIS COMPONENT IS PROVIDED "AS IS" AND WITHOUT ANY EXPRESS OR IMPLIED WARRANTIES, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTIBILITY AND FITNESS FOR A PARTICULAR PURPOSE.
`timescale 1ns / 1ps
module set_estimates(clock, reset, start_port, S_oe_ram, S_we_ram, S_addr_ram, S_Wdata_ram, S_data_ram_size, done_port, Sout_Rdata_ram, Sout_DataRdy);
  parameter MEM_var_28861_28874=32, MEM_var_28868_28874=64;
  // IN
  input clock;
  input reset;
