...
void clean_inputF(TARGET_TYPE a[size][size], TARGET_TYPE array[size]){
	head = 0;
	tail = 0;
...
{
	clean_inputF(a, array);
}

void bfsdfsF(TARGET_TYPE a[size][size], TARGET_TYPE array[size]){
	/* 
...
void depth_first_searchF(TARGET_TYPE  a[size][size], TARGET_TYPE array[size]){
